...
import {
  ...
  initializeFriendRequestsTo,
} from "../features/friendRequests/friendRequestsSlice";
import {
  getAllContacts,
  setCurrentContact,
} from "../features/contacts/contacsSlice";
import { checkAuth, logout, setCurrentUser } from "../features/auth/authSlice";
...
const Context = ({ children }) => {
  ...
  const { receivingCall, callAnswered, ongoingCall, callInitiator } =
  ...
  socket.off("user_updated").on("user_updated", (updatedUser) => {
    if (currentUser && updatedUser.is_logged_in !== currentUser.is_logged_in) {
